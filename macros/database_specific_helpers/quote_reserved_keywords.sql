{#
    Checks each column_name against a set of reserved keywords which require quotation
#}
...
{#
    TODO: #good-first-pr | reserved keywords implementation required
    for snowflake, spark and other adapters
#}
