...
export DBT_ENV_SECRET_SQLSERVER_TEST_SERVER=
export DBT_ENV_SECRET_SQLSERVER_TEST_DATABASE=
export DBT_ENV_SECRET_SQLSERVER_TEST_USER=
export DBT_ENV_SECRET_SQLSERVER_TEST_PASSWORD=
